...
def search_es_sequence_of_3(info1, info2, info3, ES, index, max_len=100, time_after=2):
    ...
    score_result_2_2, id_result_2_2, group_result_2_2 = search_es(ES, index=index, request=es_query_2, 
                                        percent_thres = 0.5, max_len=max_len)
    group_result_2_with_score = group_list_images_and_calculate_score(id_result_2_2, score_result_2_2, group_result_3_2)
...
def search_es_temporal(sent, ES, index):
    ...
    if sum(contain_info) == 1:
        ...
        final = group_list_images_and_calculate_score(id_result, score_result, group_result)
